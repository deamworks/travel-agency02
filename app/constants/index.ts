...
export const user ={name: 'Putita C.'};
export const dashboardStats ={
    totalUsers: 12480,
    usersJoined: {currentMonth: 189, lastMonth: 123},
    totalTrips: 3480,
    tripsCreated: {currentMonth:134, lastMonth: 236},
    userRole: {total: 55, currentMonth: 32, lastMonth: 21},
  }
